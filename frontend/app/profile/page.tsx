...
export default function ProfilePage() {
  ...
  return (
    <main className="relative w-screen h-screen flex flex-col items-center justify-center p-4 overflow-hidden bg-slate-900 font-sans">
      ...
      {/* ==================== 🎫 Main Card ==================== */}
      <div className="relative z-30 w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 shadow-[0_0_50px_rgba(0,0,0,0.3)] animate-fade-in overflow-hidden">
                ...
                <div className="w-full space-y-5 animate-slide-up text-left">
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 focus:border-purple-500/50 text-white p-4 rounded-xl outline-none focus:ring-2 ring-purple-500/20 transition-all placeholder:text-gray-600"
                        />
                    </div>
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-300 ml-1">เลือกรูปอวตาร (Select Avatar)</label>
                        <div className="grid grid-cols-5 gap-2 p-2 bg-white/5 rounded-xl border border-white/5">
                            {EMOJI_OPTIONS.map(e => (
                                <button 
                                    key={e} 
                ...
                <div className="w-full space-y-4 animate-slide-up text-left">
                    ...
                    <div className="space-y-1">
                         ...
                         <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 text-white p-3.5 rounded-xl outline-none focus:ring-2 ring-amber-500/20 transition-all"
                        />
                    </div>
                    ...
                    <div className="space-y-1">
                         ...
                         <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 focus:border-red-500/50 text-white p-3.5 rounded-xl outline-none focus:ring-2 ring-red-500/20 transition-all"
                        />
                    </div>
                    <div className="space-y-1">
            ...
            <div className="w-full flex flex-col gap-3 pt-5 border-t border-white/10 mt-2">
                {editMode === 'none' ? (
                    <>
                        ...
                        {/* 4. Logout (ปุ่มเล็ก ลิงก์ข้อความด้านล่างสุด) */}
